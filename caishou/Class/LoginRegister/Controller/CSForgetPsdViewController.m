...
@interface CSForgetPsdViewController ()
...
@implementation CSForgetPsdViewController
...
- (void )creatUI{
    UILabel *la = [ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:ClearColor text:@"修改密码" textColor:MainColor textAlignment:Center font:MediumFont(34)];
    ...
    UIButton *loginBtn = [ViewCreate createButtonFrame:CGRectMake(0, 0, 0, 0) title:@"确认" titleColor:WhiteColor font:MediumFont(14) backgroundColor:MainColor touchUpInsideEvent:nil];
    loginBtn.tag = 10010;
...
- (void )forgetPwd{
    ...
    [CSApiManager forgetPwdWithParamDic:paramDic CallBack:^(id  _Nonnull data) {
        MYLog(@"%@",data);
        if (ResultIsCorrect) {
            [Dialog toastCenter:@"恭喜您,修改密码成功!"];
