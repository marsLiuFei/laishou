//
//  XBLaunchIntroductionView.m
//  ShoppingMall
//
//  Created by ahxb on 2018/6/12.
//  Copyright © 2018年 ahxb. All rights reserved.
//

#import "XBLaunchIntroductionView.h"
static NSString *const kAppVersion = @"appVersion";


@interface XBLaunchIntroductionView ()<UIScrollViewDelegate>
{
...
@implementation XBLaunchIntroductionView

NSArray *images;
BOOL isScrollOut;//在最后一页再次滑动是否隐藏引导页
CGRect enterBtnFrame;
NSString *enterBtnImage;
static XBLaunchIntroductionView *launch = nil;
NSString *storyboard;
...
+(instancetype)sharedWithImages:(NSArray *)imageNames{
    images = imageNames;
    isScrollOut = YES;
    launch = [[XBLaunchIntroductionView alloc] initWithFrame:CGRectMake(0, 0, kScreen_width, kScreen_height)];
