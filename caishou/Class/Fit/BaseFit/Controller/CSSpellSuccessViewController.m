//
//  CSSpellSuccessViewController.m
//  caishou
//
...
@interface CSSpellSuccessViewController ()

@end

@implementation CSSpellSuccessViewController

-(void)viewDidLoad{
    [super viewDidLoad];
    [self setNavTitleStr:@"拼团成功"];
...
- (void )creatUI{
    UILabel *la = [ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:ClearColor text:@"恭喜您，拼团成功！" textColor:MainColor textAlignment:Center font:MediumFont(19)];
...
- (void )btnClick:(UIButton *)sender{
    if (sender.tag == 200) {
        //查看订单
        CSOrderViewController *vc = [CSOrderViewController new];
        vc.selectedIndx = 1;
        [self.navigationController pushViewController:vc animated:YES];;
    }else{
        //立即拿货没有，直接回根视图
        [Dialog toastCenter:@"暂未开通此功能"];
