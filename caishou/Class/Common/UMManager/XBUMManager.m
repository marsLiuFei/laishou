...
//    [UMCommonLogManager setUpUMCommonLogManager];
    ...
    [UMConfigure initWithAppkey:@"5c8b3c4e0cafb2a2a600174c" channel:@"App Store"];
...
+ (void)setupUSharePlatforms{
     ...
     */
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatSession appKey:@"wxffe2dfea7444359e" appSecret:@"AppSecret：b8ca7dac0e8e5d26b3b5f4b1879b1060" redirectURL:nil];
    [WXApi registerApp:@"wxffe2dfea7444359e"];//微信支付
    /*
     * 移除相应平台的分享，如微信收藏
     */
     ...
     */
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_QQ appKey:@"1108214777"/*设置QQ平台的appID*/  appSecret:@"8gOnuV4711aIrzdz" redirectURL:nil];
